...
function M.on_attach(client, bufnr)
	...
	require("vat.modules2.lsp.ext.keymaps")(client, bufnr)
	require("vat.modules2.lsp.ext.auto_diagnostic")(client, bufnr)
	-- require("vat.modules2.lsp.ext.auto_inlayhints")(client, bufnr)
	-- require("vat.modules2.lsp.ext.auto_codelenses")(client, bufnr)
	require("vat.modules2.lsp.ext.auto_codeaction")(client, bufnr)
